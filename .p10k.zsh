# Generated by Powerlevel10k configuration wizard on 2020-07-05 at 14:46 MSK.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 03380.
# Wizard options: awesome-fontconfig + powerline + python, large icons, rainbow,
# unicode, 24h time, angled separators, sharp heads, flat tails, 2 lines, disconnected,
# no frame, sparse, many icons, concise, instant_prompt=quiet.
